...
public class ClasspathResourceObjectProvider
        extends AbstractFileResourceObjectProvider<ClasspathResourceObjectProvider> {
    ...
    @Override
    protected ClasspathResourceObjectProvider self() {
        return this;
    }
